...
interface RifaCardProps {
  rifa: rifa;
  onOptions(rifa: any): void;
}

const RifaCard: React.FC<RifaCardProps> = ({ rifa, onOptions }) => {
    ...
    <TouchableOpacity onPress={toggleExpand} style={styles.cardContainer}>
      <View style={styles.card}>
        <View style={styles.cardContent}>
            ...
            {!expanded && (
              <>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <Text style={styles.userCountry}>100/100</Text>
                </View>
          ...
          <TouchableOpacity style={styles.menuButton} onPress={() => onOptions(rifa)}>
